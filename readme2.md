...
<html lang="en">
  ...
  <body>
    ...
    <main role="main">
      <aside id="sidebar">
        ...
        <nav role="navigation">
          <h3>Topic/page navigation</h3>
            ...
            <li role="presentation">
            <div class="current-page" role="menuitem">Personas, stories, wireframes</div>
              <ol role="menu">
                <li role="presentation">
                  <a href="#lesson-objectives" role="menuitem">Lesson objectives</a>
                </li>
                <li role="presentation">
                  <a href="#introductory-material" role="menuitem">Introductory material</a>
                </li>
                <li role="presentation">
                  <a href="#getting-started" role="menuitem">Getting started</a>
                </li>
                <li role="presentation">
                  <a href="#building-personas" role="menuitem">Building personas</a>
                </li>
                <li role="presentation">
                  <a href="#three-personas" role="menuitem">Three personas</a>
                  <ol role="menu">
                    <li role="presentation">
                      <a href="#student-persona" role="menuitem">Student persona</a>
                    </li>
                    <li role="presentation">
                      <a href="#instructor-persona" role="menuitem">Instructor persona</a>
                    </li>
                    <li role="presentation">
                      <a href="#guest-persona" role="menuitem">Guest persona</a>
                    </li>
                  </ol>
                </li>
                <li role="presentation">
                  <a href="#should-we-use-personas" role="menuitem">Should we use personas?</a>
                </li>
                <li role="presentation">
                  <a href="#job-stories" role="menuitem">Job stories</a>
                </li>
                <li role="presentation">
                  <a href="#how-stories-look" role="menuitem">How stories look</a>
                </li>
                <li role="presentation">
                  <a href="#choosing-a-story-format" role="menuitem">Choosing a story format</a>
                </li>
                <li role="presentation">
                  <a href="#the-wireframe" role="menuitem">The wireframe</a>
                </li>
                <li role="presentation">
                  <a href="#why-so-sketchy" role="menuitem">Why so sketchy?</a>
                </li>
                <li role="presentation">
                  <a href="#success-measures" role="menuitem">Success measures</a>
                </li>
                <li role="presentation">
                  <a href="#lesson-faq" role="menuitem">Frequently Asked Questions</a>
                </li>
                <li role="presentation">
                  <a href="#additional-resources" role="menuitem">Additional resources</a>
                </li>
              </ol>
            </li>
            <li role="presentation">
      ...
      <article id="lesson">
        <header>
          <h2>Lesson: Personas, stories, wireframes</h2>
        </header>
